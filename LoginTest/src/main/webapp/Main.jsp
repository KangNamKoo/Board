...
<body>
	...
	<div id="main_content" class="container-fluid">
		<div id="main_content_div" class="row">
			...
			<div id="main_content_text" class="col-5">
				<p><h1><b>나만의 운동루틴</b></h1>
				<br>
				<p><h5>나에게 맞는 운동을 찾아보세요</h5>
				<p><h5>초보자부터 상급자까지</h5>
				<p><h5>부위별로 원하는 운동을 해보세요</h5>
				<br>
	...
	<div id="main_content2" class="container-fluid">
		<div id="main_content_div" class="row">
			<div id="main_content_text" class="col-5">
				<p><h1><b>나의 운동 일지</b></h1>
				<br>
				<p><h5>나와 맞는 운동 파트너를 찾아보세요</h5>
				<p><h5>내 수준에 맞는 파트너와 함께</h5>
				<p><h5>혼자가 아닌 함께 운동을 해보세요</h5>
				<br>
	...
	<div id="main_content3" class="container-fluid">
		<div id="main_content_div" class="row">
			...
			<div id="main_content_text" class="col-5">
				<p><h1><b>나의 운동 파트너</b></h1>
				<br>
				<p><h5>나와 맞는 운동 파트너를 찾아보세요</h5>
				<p><h5>내 수준에 맞는 파트너와 함께</h5>
				<p><h5>혼자가 아닌 함께 운동을 해보세요</h5>
				<br>
				<button>Workout Partner</button>
			</div>
		</div>
	</div>
